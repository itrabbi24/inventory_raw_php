...
<div class="page-wrapper">
    <div class="content">
        ...
        <div class="card">
            <div class="card-body">
                <form action="depositors.php" method="GET">
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group"><label>Depositor</label>
                                <select name="depositor_id" class="select">
                                    <option value="0">All Depositors</option>
                ...
                <div class="row mt-4">
                    <div class="col-lg-4"><div class="dash-count das1"><div class="dash-counts"><h4><?php echo formatCurrency($total_deposit); ?></h4><h5>Total Deposit</h5></div></div></div>
                    <div class="col-lg-4"><div class="dash-count das2"><div class="dash-counts"><h4><?php echo formatCurrency($total_withdraw); ?></h4><h5>Total Withdraw</h5></div></div></div>
                    <div class="col-lg-4"><div class="dash-count das3"><div class="dash-counts"><h4><?php echo formatCurrency($total_deposit - $total_withdraw); ?></h4><h5>Net Balance</h5></div></div></div>
                </div>

                <div class="table-responsive mt-4">
                    <table class="table datatable">
                        <thead>
                            <tr><th>Date</th><th>Name</th><th>Type</th><th>Amount (৳)</th><th>Notes</th></tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><span class="badge <?php echo ($tr['type'] == 'deposit') ? 'bg-lightgreen' : 'bg-lightred'; ?>"><?php echo ucfirst($tr['type']); ?></span></td>
